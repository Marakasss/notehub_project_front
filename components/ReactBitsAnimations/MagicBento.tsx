...
export interface BentoCardProps {
  ...
  size?: "small" | "medium" | "wide" | "tall" | "large" | "full" | "xl";
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  .card--border-glow {
    ...
    z-index: 0; /* щоб світіння не перекривало контент */
  }
  ...
  .card--border-glow::after {
    ...
    background: radial-gradient(
      ...
      rgba(15, 150, 140, calc(var(--glow-intensity) * 0.8)) 0%,
      rgba(15, 150, 140, calc(var(--glow-intensity) * 0.4)) 30%,
      transparent 60%
    );
  ...
  .card--border-glow:hover {
   box-shadow:
    0 4px 20px rgba(30, 150, 120, 0.2),   
    0 0 30px rgba(90, 220, 190, 0.1),     
    0 0 40px rgba(132, 0, 255, 0.1);     
  }
...
`}
    ...
    ${card.alwaysGlow ? "card--glow-always" : ""}
    ${sizeClass}
